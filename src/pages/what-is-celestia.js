								...
								<section className={"modular-blockchain-section"}>
									<div className={"row justify-content-between align-items-center"}>
										<div className={"col-12 col-lg-6"}>
											...
											<p>
												You already know Celestia as the first modular blockchain network. But here’s the simple version of
												what Celestia actually does. It’s a layer 1 blockchain whose only job is to order transactions and
												make them available to download for anyone who wants to.
											</p>
											<p>
												And Celestia is only one piece of the puzzle. Applications live on other blockchains which use
												Celestia to publish data. These blockchains can come in all shapes and sizes, like rollups or layer
												2s.
											</p>
											<p>
												But Celestia is more than just a place to publish data. It’s a platform that enables anyone to deploy
												their own blockchain easily.
											</p>
										</div>
										<div className={"image-box--modular col-12 col-lg-6"}>
											<div className='image-wrapper'>
												<img style={{ width: `100%` }} src={celestia_modular} alt={""} />
											</div>
										</div>
									</div>
								</section>
								...
								<section className={"data-availability-section"}>
									<div className={"row justify-content-between align-items-center"}>
										<div className={"col-12 col-lg-6"}>
											<h2 className='title'>What is data availability and why does it matter?</h2>
											<p>
												Data availability is critical to the security of any blockchain because it ensures that anyone can
												inspect the ledger of transactions and verify it. Data availability answers the question, has the data
												for this blockchain been published?
											</p>
											<p>Users of a monolithic blockchain download all the data to check that it is available.</p>
											<p>
												As blocks get bigger, it becomes impractical for normal users to download all the data meaning that
								...
								<section className={"rollups-section"}>
									<div className={"row justify-content-between align-items-center"}>
										...
										<div className={"order-1 order-lg-2 col-12 col-lg-6"}>
											<h2 className='title'>What are rollups and how do they work with Celestia?</h2>
											<p>
												Rollups are a type of blockchain that offload some work to a layer 1 like Celestia. Rollups host apps
												and process user transactions. By hosting apps across many different rollups, apps do not have to
												compete for computational resources with each other.
											</p>
											<p>
												Once rollup transactions get processed, they are then published to Celestia. Celestia’s job is to
												order those transactions and check that they are available to download.
											</p>
										</div>
									</div>
								</section>
