	...
	render() {
		return (
			<div className={"glossary-content"}>
				<p>
					A group of validators that are responsible for directly participating in the consensus of a blockchain through either voting,
					producing, or proposing blocks.
				</p>
			</div>
		);
	}
