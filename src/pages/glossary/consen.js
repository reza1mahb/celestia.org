    ...
    render() {
        return (
            <div className={'glossary-content'}>
                <p>Consensus refers to a function of modular blockchains where the ordering of transactions is agreed upon by a set of <a href="https://celestia.org/glossary/validator/" target="_blank" rel="noopener noreferrer" style="color:#7B2BF9;">validators</a>. To agree on the order of transactions in a block, validators follow a <a href="https://celestia.org/glossary/consensus-algorithm/" target="_blank" rel="noopener noreferrer" style="color:#7B2BF9;">consensus algorithm</a>.
                </p>
